...
const CACHE_VERSION = "enola-v135";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./js/cambio-moneda.js",
  "./js/traspasos.js",
  "./js/posicion-inicial.js",
  "./js/posicion-cerrada.js",
  "./js/valuaciones.js",
  "./js/mep.js",
  "./js/importar-balanz.js",
  "./js/unificar-tickers.js",
  "./js/dashboard.js",
  "./js/inflacion.js",
  "./js/ahorros.js",
...
self.addEventListener("fetch", (event) => {
  ...
  // CDN externo (XLSX.js, Chart.js): pasar directamente a la red
